  ...
  >
    <defs>
      <path
        ...
        id="settings-white_icon_svg__a"
      />
    </defs>
    <g fill="none" fillRule="evenodd">
      <use fill={props.fill} xlinkHref="#settings-white_icon_svg__a" />
      <path
...
const ForwardRef = forwardRef(SvgSettingsWhiteicon);
