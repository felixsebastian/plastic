  ...
  >
    <defs>
      <path
        ...
        id="demographics_icon_svg__a"
      />
    </defs>
    <use fill={fill} fillRule="nonzero" xlinkHref="#demographics_icon_svg__a" />
  </svg>
);

const ForwardRef = forwardRef(SvgDemographicsicon);
